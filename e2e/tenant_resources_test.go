...
var _ = Describe("creating namespaces within a Tenant with resources", func() {
	...
	It("should contains all Limit Range resources", func() {
		for _, ns := range nsl {
	...
	It("should contains all Network Policy resources", func() {
		for _, ns := range nsl {
	...
	It("should match Namespace scheduler annotation", func() {
